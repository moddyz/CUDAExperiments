...
using TestUnifiedTypes     = std::tuple<Array<ValueT, Host>, Array<ValueT, CUDA>>;
using TestIndexAccessTypes = std::tuple<Array<ValueT, Host>>;
...
TEMPLATE_LIST_TEST_CASE( "Array_InitializerListConstructor", "[template][list]", TestUnifiedTypes )
{
    ...
    Array<ValueT, Host> hostArray = array;
